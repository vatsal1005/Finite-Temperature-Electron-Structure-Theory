...
# dm_o = np.zeros((o_act,o_act))
# dm_v = np.zeros((v_act,v_act))

# for v in range(0,o_act):
#     dm_o[v,v] = cp.deepcopy(dm[occ-o_act+v,occ-o_act+v])

# for u in range(0,v_act):
#     dm_v[u,u] = cp.deepcopy(dm[u+occ,u+occ]) 

# print("So density Matrix:", dm_o)
# print("Sv density Matrix:", dm_v)
